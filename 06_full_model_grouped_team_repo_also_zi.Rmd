...
```{r}
heatmap_by_team_and_repo(posterior_predict_by_team_and_repo(m, added=mean(data$ADD), removed=mean(data$DEL), complexity = mean(data$COMPLEX), duplicates = mean(data$DUP)), "percent zeros", decimals=2)
```
